    ...
    else 
    {
        $navItems[] = [
            ...
            'items' => [
                ...
                ['label' => 'Выйти', 'url' => ['/logout'],'linkOptions' => ['data-method' => 'post'],],
            ],
            'dropdownOptions' => ['class' => 'dropdown-menu-end'],
        ];

        if(Yii::$app->user->can('administrator')) {
            $userItem = ['label' => 'Пользователи', 'url' => ['/admin/user']];
            array_splice($navItems[0]['items'], 0, 0, [$userItem]);
        }
    }
